...
<div class="about__buttons d-flex flex-column flex-md-row gap-md-3 justify-content-center">
        ...
        <button class="btn linkedin p-sm-2 px-md-2 py-md-1"><h5><i class="fa-brands fa-linkedin"></i> LinkedIn</h5></button>
    <button class="btn github p-sm-2 px-md-2 py-md-1"><h5><i class="fa-brands fa-github"></i> Github</h5></button>
</div>
</div>`;
}